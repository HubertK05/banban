<script lang="ts">
    ...
    import { activitiesRune, categoriesRune, categoryTagsRune, idOtherTags, idTags, otherTagsRune } from "../../../shared.svelte";
    ...
    <div class="flex flex-row mt-2 place-content-between align-center p-1 rounded-md">
        ...
        {:else}
            ...
            <div class="flex flex-row">
                ...
                <button
                    class="flex items-center justify-center w-10 h-10 ml-auto rounded hover:bg-error-hover-token"
                    onclick={() => {editableCategory = { id: +categoryId, name: category.name }}}>
